                ...
                <div className="max-w-3xl mx-auto">
                    <header className="mb-12">
                        ...
                        <p className="text-xl text-slate-500 leading-relaxed mb-8">
                            The exact process top-performing recruitment teams use to cut hiring time in half â€” without sacrificing candidate quality or culture fit.
                        </p>
                        <div className="flex items-center gap-4 text-[10px] font-black uppercase tracking-widest text-slate-400 pb-8 border-b border-slate-100">
                            <span>March 28, 2026</span><span>Â·</span><span>6 min read</span><span>Â·</span><span>Recruit Flow Team</span>
                        </div>
                    </header>

                    <div className="space-y-8 text-slate-700 leading-relaxed">
                        <p className="text-lg">
                            The average time-to-hire across industries is <strong className="text-slate-900">44 days</strong>. For tech roles, it's often longer. Every day a role stays open costs money â€” in lost productivity, in team strain, and in the risk of losing your top candidate to a faster-moving competitor.
                        </p>
                        ...
                        <div className="bg-slate-50 border border-slate-100 rounded-sm p-6 space-y-3">
                            {[
                                ['Resume screening', '7â€“14 days', 'Reading every CV manually'],
                                ['Scheduling interviews', '3â€“7 days', 'Back-and-forth email coordination'],
                                ['Interview rounds', '7â€“14 days', 'Multiple rounds with multiple stakeholders'],
                                ['Decision & offer', '3â€“7 days', 'Internal alignment and approval'],
                                ['Candidate response', '2â€“5 days', 'Waiting for acceptance'],
                        ...
                        <h2 className="text-2xl font-black text-slate-900 mt-12 mb-4">Step 1: Automate Resume Screening (Save 7â€“14 Days)</h2>
                        <p>This is the single biggest lever. If you're manually reading every resume, you're spending a week or more just to create a shortlist. AI screening tools like Recruit Flow do this in seconds â€” every resume gets an ATS score and written summary the moment it's submitted.</p>
                        ...
                        <h2 className="text-2xl font-black text-slate-900 mt-12 mb-4">Step 2: Reduce Interview Rounds (Save 7â€“10 Days)</h2>
                        <p>Most companies do too many interview rounds. Three rounds is the maximum for most roles â€” anything beyond that is usually about internal politics, not candidate evaluation.</p>
                        ...
                        <h2 className="text-2xl font-black text-slate-900 mt-12 mb-4">Step 3: Eliminate Scheduling Friction (Save 3â€“5 Days)</h2>
                        ...
                        <h2 className="text-2xl font-black text-slate-900 mt-12 mb-4">Step 4: Make Faster Decisions (Save 3â€“5 Days)</h2>
                        ...
                        <div className="bg-slate-50 border border-slate-100 rounded-sm p-6 space-y-3">
                            {[
                                ...
                                ['Day 2â€“3', 'Review AI summaries, shortlist top 10'],
                                ['Day 4â€“5', 'Round 1 interviews (30 min each, back-to-back)'],
                                ['Day 6â€“7', 'Round 2 for top 3 candidates'],
                                ['Day 8', 'Decision and offer sent'],
                                ['Day 9â€“10', 'Candidate accepts, paperwork begins'],
                            ].map(([day, action], i) => (
                        ...
                        <p>This isn't theoretical. It's the process that fast-moving companies actually use. The key is removing the administrative friction â€” and AI screening is the biggest single lever you have.</p>
